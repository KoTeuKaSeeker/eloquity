...
class MessageTranscribeAudioCommand(TranscribeAudioCommand):
    def __init__(self, filter_factory: MessageFilterFactoryInterface, dropbox_manager: DropBoxManager, task_extractor: TaskExtractor, bitrix_manager: BitrixManager, transcricribe_request_log_dir: str):
        super().__init__(filter_factory, MessageAudioLoader(dropbox_manager), task_extractor, transcricribe_request_log_dir, bitrix_manager, "message_speaker_correction_state")
