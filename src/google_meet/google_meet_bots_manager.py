...
class GoogleMeetBotsManager(DisconnectBotCallbackInterface):
    ...
    def __init__(self, profile_path: str, audio_recorder: ObsAudioRecorder, bot_profile_indices: List[int] = [], show_browser: bool = False):
        self.meets_data = {}
        ...
        self.bots: List[GoogleMeetBot] = [GoogleMeetBot(profile_path, id, audio_recorder, show_browser) for id in bot_profile_indices]
